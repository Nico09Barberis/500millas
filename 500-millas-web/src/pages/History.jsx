  ...
  const sections = [
    {
      ...
      text2: "Lo que comenzó como un proyecto familiar con sueños y aspiraciones, hoy se ha transformado en una empresa consolidada que se enorgullece de sus raíces y valores.",
      text3: "Cada paso que dimos estuvo guiado por la pasión por lo que hacemos y el deseo de generar un impacto positivo en nuestra comunidad.",
      image: img1,
    },
    {
      ...
      text2: "El crecimiento no solo se mide en cifras, sino en la confianza que nuestros clientes y colaboradores depositan en nosotros día a día.",
      text3: "Cada logro ha sido fruto del trabajo conjunto, la creatividad y la capacidad de adaptarnos a un mercado en constante cambio.",
      image: img2,
    },
    {
      ...
      text2: "Nuestra visión se basa en la dedicación, el trabajo en equipo y la innovación constante, pilares que nos permiten enfrentar cualquier desafío con seguridad.",
      text3: "Aspiramos a ser referentes en nuestro sector, impulsando proyectos que generen valor y contribuyan al bienestar de nuestra comunidad y del medio ambiente.",
      image: img3,
    },
  ];

  return (
    <section className="relative py-24 px-6 bg-gradient-to-b from-white via-[#f5e7c6] to-white">
      {/* Overlay dorado más marcado */}
      <div className="absolute inset-0 bg-gradient-to-tr from-[#e6c78e]/40 via-transparent to-[#e6c78e]/30 pointer-events-none"></div>

      <div className="relative max-w-6xl mx-auto mt-28 md:mt-28">
        {/* Título central */}
        <h1 className="text-4xl md:text-5xl font-bold text-center text-gray-900 tracking-wide mb-20 relative">
          <span className="font-ancois-one relative z-10">Nuestra Historia</span>
          ...
          {sections.map((sec, index) => (
            ...
            >
              ...
              <div className="md:w-1/2 bg-white/90 backdrop-blur-sm rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-500 border-l-4 border-[#e6c78e]">
                ...
                <p className="font-ancois-one text-gray-700 leading-relaxed mb-4">{sec.text}</p>
                <p className="font-ancois-one text-gray-700 leading-relaxed mb-4">{sec.text2}</p>
                <p className="font-ancois-one text-gray-700 leading-relaxed">{sec.text3}</p>
              </div>
            </div>
          ))}
        </div>
